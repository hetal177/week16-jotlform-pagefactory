package com.joltform.utility;

import com.google.common.base.Function;
import com.joltform.drivermanager.ManageDriver;
...
//********* Action Methods *************//
    ...
    public void dragAndDrop(WebElement element) {
        ...
        Actions actions = new Actions(driver);
        actions.dragAndDropBy(element, 200, 100).build().perform();
        actions.dragAndDropBy(element, 70, 70).build().perform();
        actions.dragAndDropBy(element, 100, 50).build().perform();
        actions.dragAndDropBy(element, 30, 70).build().perform();
